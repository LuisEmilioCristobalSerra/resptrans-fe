...
import InformationForm from '@/components/Item/InformationForm.vue'
...
const getAll = async (options) => {
  const { data } = await Item.all(options)
  return data
}
